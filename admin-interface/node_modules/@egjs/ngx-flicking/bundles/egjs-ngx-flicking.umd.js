(function (global, factory) {
...
}(this, (function (exports, VanillaFlicking, i0, common, ListDiffer) { 'use strict';
    ...
    var NgxFlickingService = /** @class */ (function () {
        // eslint-disable-next-line @typescript-eslint/no-empty-function
        function NgxFlickingService() {
        }
        return NgxFlickingService;
    }());
    NgxFlickingService.ɵprov = i0.ɵɵdefineInjectable({ factory: function NgxFlickingService_Factory() { return new NgxFlickingService(); }, token: NgxFlickingService, providedIn: "root" });
    NgxFlickingService.decorators = [
        { type: i0.Injectable, args: [{
                    providedIn: "root"
                },] }
    ];
    NgxFlickingService.ctorParameters = function () { return []; };
    ...
    ***************************************************************************** */
    ...
    var NgxFlickingComponent = /** @class */ (function (_super) {
        ...
        function NgxFlickingComponent(elRef, renderer, platformId) {
            ...
            EVENT_NAMES.forEach(function (evtName) {
                _this[evtName] = new i0.EventEmitter();
            });
            return _this;
        }
        ...
        NgxFlickingComponent.prototype.ngAfterViewInit = function () {
            ...
            var flicking = new VanillaFlicking__default(viewportEl, Object.assign(Object.assign({}, this.options), { externalRenderer: new NgxRenderer(rendererOptions) }));
    ...
    NgxFlickingComponent.propDecorators = {
        ...
        hideBeforeInit: [{ type: i0.Input }],
        firstPanelSize: [{ type: i0.Input }],
        ready: [{ type: i0.Output }],
        beforeResize: [{ type: i0.Output }],
        afterResize: [{ type: i0.Output }],
        holdStart: [{ type: i0.Output }],
        holdEnd: [{ type: i0.Output }],
        moveStart: [{ type: i0.Output }],
        move: [{ type: i0.Output }],
        moveEnd: [{ type: i0.Output }],
        willChange: [{ type: i0.Output }],
        changed: [{ type: i0.Output }],
        willRestore: [{ type: i0.Output }],
        restored: [{ type: i0.Output }],
        select: [{ type: i0.Output }],
        needPanel: [{ type: i0.Output }],
        visibleChange: [{ type: i0.Output }],
        reachEdge: [{ type: i0.Output }],
        panelChange: [{ type: i0.Output }],
        isVertical: [{ type: i0.HostBinding, args: ["class.vertical",] }],
        isHiddenBeforeInit: [{ type: i0.HostBinding, args: ["class.flicking-hidden",] }],
        _ngxPanels: [{ type: i0.ContentChildren, args: [NgxFlickingPanel,] }]
    };
    ...
    exports.NgxFlickingService = NgxFlickingService;
