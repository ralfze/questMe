...
import { ɵɵdefineInjectable, Injectable, Directive, ElementRef, Renderer2, EventEmitter, Component, ViewEncapsulation, Inject, PLATFORM_ID, Input, Output, HostBinding, ContentChildren, NgModule } from '@angular/core';
import { isPlatformBrowser, CommonModule } from '@angular/common';
import ListDiffer from '@egjs/list-differ';
import { __decorate, __metadata, __awaiter } from 'tslib';

class NgxFlickingService {
    // eslint-disable-next-line @typescript-eslint/no-empty-function
    constructor() { }
}
NgxFlickingService.ɵfac = function NgxFlickingService_Factory(t) { return new (t || NgxFlickingService)(); };
NgxFlickingService.ɵprov = ɵɵdefineInjectable({ factory: function NgxFlickingService_Factory() { return new NgxFlickingService(); }, token: NgxFlickingService, providedIn: "root" });
NgxFlickingService.ctorParameters = () => [];
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxFlickingService, [{
        type: Injectable,
        args: [{
                providedIn: "root"
            }]
...
class NgxFlickingComponent extends FlickingInterface {
    ...
    ngAfterViewInit() {
        ...
        const flicking = new VanillaFlicking__default(viewportEl, Object.assign(Object.assign({}, this.options), { externalRenderer: new NgxRenderer(rendererOptions) }));
...
NgxFlickingModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [NgxFlickingService], imports: [[CommonModule]] });
...
export { NgxFlickingComponent, NgxFlickingModule, NgxFlickingPanel, NgxFlickingService };
