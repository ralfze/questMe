    ...
    */
    ...
    var NormalRenderingStrategy = function () {
      ...
      __proto.getRenderingIndexesByOrder = function (flicking) {
        ...
        return __spreadArray(__spreadArray(__spreadArray([], __read$1(toggledPrev)), __read$1(notToggled)), __read$1(toggledNext)).map(function (panel) {
          return panel.index;
        });
      };
      ...
      __proto.createPanel = function (element, options) {
        return new this._panelCtor(__assign$2(__assign$2({}, options), {
    ...
    var VirtualRenderingStrategy = function () {
      ...
      __proto.getRenderingIndexesByOrder = function (flicking) {
        ...
        return __spreadArray(__spreadArray([], __read$1(visibleIndexes)), __read$1(invisibleIndexes));
      };
