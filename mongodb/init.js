    ...
    "data": [
      {
        ...
        "answers": [
          { "answer": "Du sprichst von der Konsole, die Anwendung ist {{ app }} der Kanal ist {{ channel }}", "opts": "channel==='console'" },
          { "answer": "Du sprichst von der Directline, die Anwendung ist {{ app }} der Kanal ist {{ channel }}", "opts": "channel==='directline'" },
          { "answer": "Du sprichst vom Microsoft Emulator, die Anwendung ist {{ app }} der Kanal ist {{ channel }}", "opts": "channel==='msbf-emulator'" }
        ]
      },
      {
      ...
      },
      {
        ...
        "answers": [
          "Gewiss gebe ich mir Mühe",
          "Ich arbeite definitv daran"
        ]
      },
      {
      ...
      },
      {
        ...
        "answers": [
          "Ich stimme dir zu!",
          "Erfreulich dass du auch so denkst"
        ]
      },
      {
      ...
      },
      {
        ...
        "answers": [
          "Mein Vergnügen",
          "Erfreulich, dass ich helfen konnte"
        ]
      },
      {
